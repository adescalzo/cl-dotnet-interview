...
{
    public async Task<Result<AddTodoItemResponse>> Handle(AddTodoItemCommand command, CancellationToken ct)
    {
        ...
        return Result.Success(new AddTodoItemResponse(todoList.Id, item.Name, item.IsComplete));
    }
}
